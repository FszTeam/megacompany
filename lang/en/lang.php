<?php return [
    'plugin' => [
        'name' => 'MegaCompany',
        'description' => 'A plugin to show information about your megacompany',
    ],
    'employee' => [
        'new' => 'New Employee',
        'label' => 'Employee',
    ...
    'components' => [
        ...
        'megacompany' => [
            'name' => 'MegaCompany',
            'description' => 'Show your megacompany information',
        ],
        'testimonials' => [
            'name' => 'Testimonials',
        ...
        'roles' => [
            'name' => 'Roles',
            'description' => 'Show your megacompany roles',
        ],
        'tags' => [
            'name' => 'Tags Component',
        ...
        'categories' => [
            ...
            'description' => 'category component description',
        ],
    ],
    'role' => [
        'new' => 'New Role',
    ...
    'settings' => [
        'label' => 'Settings',
        'description' => 'Change basic settings for your megacompany',
    ],
    'megacompany' => [
    ...
    'categories' => [
        'category_component','Categories Component',
        'delete_selected_confirm' => 'Delete the selected Links?',
